...
def get_model(img_size):
    ...
    # Entry block
    e1 = layers.Conv3D(8, 3, strides=1, padding="same", input_shape=(1, 64, 64, 64, 1))(inputs)
    e2 = layers.BatchNormalization()(e1)
    e3 = layers.Activation("relu")(e2)

    e4 = layers.Conv3D(8,3, strides=1, padding='same')(e3)
    ...
    #Down Block 2
    db2conv1 = layers.Conv3D(32,3, strides=1, padding='same')(pool_1)
    db2bn1 = layers.BatchNormalization()(db2conv1)
    db2act1 = layers.Activation("relu")(db2bn1)

    db2conv2 = layers.Conv3D(32,3, strides=1, padding='same')(db2act1)
    ...
    # bott Block
    db3conv1 = layers.Conv3D(64, 3, strides=1, padding='same')(pool_2)
    db3bn1 = layers.BatchNormalization()(db3conv1)
    db3act1 = layers.Activation("relu")(db3bn1)

    db3conv2 = layers.Conv3D(64, 3, strides=1, padding='same')(db3act1)
    ...
    up2conv1 = layers.Conv3D(32, 3, strides=1, padding="same")(up2conc)
    up2bn1 = layers.BatchNormalization()(up2conv1)
    up2act1 = layers.Activation("relu")(up2bn1)

    up2conv2 = layers.Conv3D(32, 3, strides=1, padding="same")(up2act1)
    ...
    up0conv1 = layers.Conv3D(8,3,strides=1, padding="same")(up0conc)
    up0bn1 = layers.BatchNormalization()(up0conv1)
    up0act1 = layers.Activation("relu")(up0bn1)

    up0conv2 = layers.Conv3D(8,3,strides=1, padding="same")(up0act1)
