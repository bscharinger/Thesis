...
def get_model(img_size):
    ...
    # Entry block
    e1 = layers.Conv3D(16, 3, strides=1, padding="same", input_shape=(1, 512, 512, 40, 1))(inputs)
    ...
    #Bottom Block
    db3conv1 = layers.Conv3D(16,3, strides=1, padding='same')(pool_2)
    db3bn1 = layers.BatchNormalization()(db3conv1)
    db3act1 = layers.Activation("relu")(db3bn1)

    db3conv2 = layers.Conv3D(16,3, strides=1, padding='same')(db3act1)
